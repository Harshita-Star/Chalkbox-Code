...
{ */
	parameters.put("MID",list.getPaytm_mid());
	...
	parameters.put("CALLBACK_URL", "http://www.chalkboxerp.in/DM/pgResponse.jsp");
	//parameters.put("CALLBACK_URL", "http://localhost:8080/Chalkbox/pgResponse.jsp");
...
{
	parameters.put("MID","BLMBlo43887663064832");
	parameters.put("CHANNEL_ID","WEB");
	parameters.put("INDUSTRY_TYPE_ID","PrivateEducation");
	parameters.put("WEBSITE","WEBPROD");
	parameters.put("MOBILE_NO","9876543210");
