<%@page import="Json.AddVisitorImageJsonBean"%>
<%@page import="Json.PickUpStudentOtherJson"%>
...
<%
   ...
   String schId=request.getParameter("schId");
	String visitorNo=new DatabaseMethods1().generateVisitorNo(schId,conn);
	String name = request.getParameter("name");
	String mobileNo = request.getParameter("mobileNo");
	String address = request.getParameter("address");
	String purpose = request.getParameter("purpose");
	String toMeet = request.getParameter("toMeet");
	String toMeetName=request.getParameter("toMeetName");
      ...
      try { 
         ...
         while ( i.hasNext () ) {
            ...
            if ( !fi.isFormField () ) {
               ...
               String fileName1 = "visitor"+time+"_"+String.valueOf(randomPIN)+".jpg";
         ...
         String inTime = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss a").format(new Date());
  	     new AddVisitorImageJsonBean().addVisitor(addDate, visitorNo, name, mobileNo, address, toMeet, purpose, otherDetails, noOfPerson, personName, allfilename, inTime, toMeetName, schId);
