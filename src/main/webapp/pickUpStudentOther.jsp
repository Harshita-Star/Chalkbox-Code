...
<%
   ...
   String addNo = request.getParameter("addNo");
	...
	String gMobileNo = request.getParameter("gMobileNo");
      ...
      try { 
         ...
         while ( i.hasNext () ) {
            ...
            if ( !fi.isFormField () ) {
               ...
               String fileName1 = "pickupOther"+time+"_"+String.valueOf(randomPIN)+".jpg";
         ...
         //(allfilename);
  	     new PickUpStudentOtherJson().pickup(gType, gRelation, gName, gMobileNo, allfilename, addNo, remark, schid,userid);
