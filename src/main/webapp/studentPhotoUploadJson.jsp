<%@page import="Json.StudentPhotoUploadJsonBean"%>
      ...
      try { 
         ...
         while ( i.hasNext () ) {
            ...
            if ( !fi.isFormField () ) {
               ...
               String fileName1 = "Photo"+time+"_"+String.valueOf(randomPIN)+ext;
         ...
         //(allfilename);
  	     new StudentPhotoUploadJsonBean().addPhoto(studentid, schid, type, allfilename);
