...
<%
   ...
   String  link = request.getParameter("youtubelink");
   String ext=request.getParameter("extension");
   	
	String [] extn=ext.split("#CB#");
	System.out.println(extn.length);
      ...
      try { 
         ...
         while ( i.hasNext () ) {
            ...
            if ( !fi.isFormField () ) {
               ...
               String fileName1 = "onlineLacture"+time+"_"+String.valueOf(randomPIN)+extn[ii];
               System.out.println(extn[ii]);
         ...
         //(allfilename);
  	     new AddOnlineLactureJson().addOnlineLacture(userid, classid, sectionid, subjectid, desc, schid, allfilename,title,link);
