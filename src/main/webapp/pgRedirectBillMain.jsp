...
//parameters.put("CALLBACK_URL", "http://www.chalkboxerp.in/DMM/pgResponseBillMain.jsp");
  parameters.put("CALLBACK_URL", "http://localhost:8083/Chalkbox/pgResponseBillMain.jsp");
