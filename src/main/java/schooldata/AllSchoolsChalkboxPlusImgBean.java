...
@ManagedBean(name="evdSchoolImg")
@ViewScoped
public class AllSchoolsChalkboxPlusImgBean implements Serializable
{
	...
	String senderid,appType,oldAdminApp,type,admoNoDupl;
	...
	public AllSchoolsChalkboxPlusImgBean()
	{
		...
		dataList=new DatabaseMethods1().allSchoolList(conn);
		try {
			conn.close();
	...
	public void editSelectedRow()
	{
		...
		admoNoDupl = selectedRow.getAdmNoDupl();
	...
	public void updatePassword()
	{
		...
		if(i==1)
		{
			...
			dataList=obj.allSchoolList(conn);
			password="";
		}
		else
		{
	...
	public void updateDetails()
	{
		...
		else
		{
			...
			if(i==1)
			{
				...
				DBM.updateSchoolDetails(schoolName,contactNo,id,conn,schoolSession,feeStart,senderid,adminApp,stApp,type,admoNoDupl);
	...
	public String getAdmoNoDupl() {
		return admoNoDupl;
	}
	public void setAdmoNoDupl(String admoNoDupl) {
		this.admoNoDupl = admoNoDupl;
	}
