...
@ManagedBean(name="cbscDuplicateTc")
@ViewScoped
public class CbscDuplicateTc implements Serializable
{
	private static final long serialVersionUID = 1L;
	String reason,lastClass,tcNumber,text,previousClass,session,headerImage,schoolExamWord,result,promotedClassWord,schNo,website,perfom,classname2,schoolAffilationNo,dob1,startingdate1,dobinword,fullName,classname1,addmissionnumber;
	...
	String previosClassWord="",stadhar="",madhar="",fadhar="",ncc="",lastSession="";
	public CbscDuplicateTc()
	{
		...
		tcType=(String) ss.getAttribute("tcType");
		...
		if(info.getBranch_id().equals("99")||info.getBranch_id().equals("101")) {
			...
			if(gamesPlayed.equals("N.A.")&& extraActivity.equals("N.A.")){
				gamesPlayed="N.A.";
			}else if ((gamesPlayed.equals("") && extraActivity.equals("N.A."))
					||(gamesPlayed.equals("N.A.") && extraActivity.equals(""))) {
				gamesPlayed="N.A.";
			} 
			else{
