...
@ManagedBean(name="masterFeeReceiptBean")
@ViewScoped

public class MasterFeeReceiptBean implements Serializable
{
	boolean show=false;
	...
	public MasterFeeReceiptBean()
	{
		...
		SchoolInfoList info1=db.fullSchoolInfo(schid,conn);
