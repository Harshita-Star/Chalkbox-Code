...
@ViewScoped
public class DailyFeeCollection implements Serializable
{
	private static final long serialVersionUID = 1L;
	String regex=RegexPattern.REGEX;
	Date feedate=new Date(),endDate;
	String date;
	boolean show,checkLock;
	...
	public void showdailyfeelist()
	{
		...
		{*/
			...
			//(new Date());
			dailyfee=obj.dailyFeeReportHeaderWiseForBLM(schid, feedate, sectionid, endDate, tempMap, conn, selectedOperator,selectedConcession,paymentModeSelected);
