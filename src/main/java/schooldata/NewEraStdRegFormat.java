...
@ManagedBean(name="newEraRegFormat")
@ViewScoped
public class NewEraStdRegFormat implements Serializable
{
	...
	public NewEraStdRegFormat()
	{
		...
		for(StudentInfo selStd:listOfStudent)
		{
			...
			if(selStd.getClassFromName().equalsIgnoreCase("IX") || selStd.getClassFromName().equalsIgnoreCase("9") 
					|| selStd.getClassFromName().equalsIgnoreCase("9th") || selStd.getClassFromName().equalsIgnoreCase("Ninth") )
			{
				selStd.setPreviousClass("X");
			}
			else if(selStd.getClassFromName().equalsIgnoreCase("XI") || selStd.getClassFromName().equalsIgnoreCase("11") 
					|| selStd.getClassFromName().equalsIgnoreCase("11th") || selStd.getClassFromName().equalsIgnoreCase("Eleventh"))
			{
