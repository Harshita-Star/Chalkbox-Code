...
@ManagedBean(name="zoneSchoolList")
@ViewScoped
public class ZoneWiseSchoolListBean implements Serializable
{
	...
	public ZoneWiseSchoolListBean()
	{
		Connection conn=DataBaseConnection.javaConnection();
		countryList=obj.zoneList(conn);
	...
	public void searchData()
	{
		...
		dataList=obj.countryWiseSchoolList(selectedCountry,"zone",conn);
		try {
			conn.close();
		} catch (SQLException e) {
			e.printStackTrace();
