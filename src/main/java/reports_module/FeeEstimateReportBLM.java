...
@ManagedBean (name="feeEstimateBLM")
@ViewScoped
public class FeeEstimateReportBLM implements Serializable
{
	...
	public void searchReport()
	{
		...
		if(selectedSchool.equals("-1"))
		{
			...
			feeEstimateList=dbr.feeEstimateReportForBLM(installmentList,classList,feeInfo,"251",selectedClass,selectedSection,conn);

			classList=obj.allClass("252",conn);
			feeInfo=obj.viewFeeListForDues("252",conn);
			feeEstimateList2=dbr.feeEstimateReportForBLM(installmentList,classList,feeInfo,"252",selectedClass,selectedSection,conn);
		...
		{
			feeEstimateList=dbr.feeEstimateReportForBLM(installmentList,classList,feeInfo,selectedSchool,selectedClass,selectedSection,conn);
		}
