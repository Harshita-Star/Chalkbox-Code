...
@ManagedBean(name="districtSchoolList")
@ViewScoped
public class DistrictWiseSchoolListBean implements Serializable
{
	...
	public DistrictWiseSchoolListBean()
	{
		Connection conn=DataBaseConnection.javaConnection();
		countryList=obj.districtList(conn);
	...
	public void searchData()
	{
		...
		dataList=obj.countryWiseSchoolList(selectedCountry,"district",conn);
		try {
			conn.close();
		} catch (SQLException e) {
			e.printStackTrace();
