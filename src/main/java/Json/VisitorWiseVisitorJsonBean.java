...
@ManagedBean(name="visitorWiseVisitorJson")
@ViewScoped
public class VisitorWiseVisitorJsonBean implements Serializable
{
	String json;
	DataBaseMeathodJson DBJ=new DataBaseMeathodJson();

	public VisitorWiseVisitorJsonBean()
	{
		...
		try {
			...
			String selectedVisitor=params.get("selectedVisitor");
			...
			if(checkRequest)
			{
				...
				visitorList=new DataBaseMethodsReports().visitorWiseVisitorReport(selectedVisitor,conn);
