...
@ManagedBean(name="viewSubjectNotesBean")
@ViewScoped
public class ViewSubjectNotesJsonBean implements Serializable {
...
String json;
	...
	public ViewSubjectNotesJsonBean() {
		...
		try {
			...
			if(checkRequest)
			{
				list = DBJ.viewSubjectNotesjson(selectedSection, newDate, endDate, schid, conn, selectedCLassSection, subjectid);
