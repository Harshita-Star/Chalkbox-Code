...
@ManagedBean(name="autoEventReminderAdminJsonBean")
@ViewScoped
public class AutoEventReminderAdminJsonBean implements Serializable
{
   ...
   public AutoEventReminderAdminJsonBean() 
   {
...
//									{
//										DBJ.notification("Reminder",message,ci.getSectionId()+"-"+ci.getClassid()+"-"+obj.schoolId(),obj.schoolId(),"",conn);
//									}
//								}
//								else
//								{
...
//								}
									...
									DBJ.adminnotification("Reminder",message,"admin-"+ss.getId(),ss.getId(),"Event Reminder admin",conn);
