...
@ManagedBean(name="allIssueBookJson")
@ViewScoped

public class AllIssueBookJsonBean implements Serializable
{
	String json;
	...
	public AllIssueBookJsonBean()
	{
		...
		try {
			...
			if(checkRequest)
			{
				allBook=new DataBaseMethodsLibraryModule().assignBookReport(schId,"from Json",null,null,conn);
