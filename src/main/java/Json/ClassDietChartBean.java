...
@ManagedBean(name="dietJson")
@ViewScoped

public class ClassDietChartBean implements Serializable
{
	String json;
	...
	public ClassDietChartBean()
	{
		...
		try {
			...
			if(checkRequest)
			{
				...
				ArrayList<DietInfo>dietList=DBJ.allDietList(selectedCLassSection,schoolid,conn);

				for(DietInfo ss:dietList)
				{
					JSONObject obj = new JSONObject();
					obj.put("day", ss.getDayName());
					obj.put("diet", ss.getDiet());
					obj.put("special_Ins", ss.getSpecialIns());
