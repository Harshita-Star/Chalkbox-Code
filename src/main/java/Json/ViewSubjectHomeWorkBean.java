...
@ManagedBean(name="viewSubjectHomeWorkBean")
@ViewScoped

public class ViewSubjectHomeWorkBean implements Serializable
{
	String json;
	...
	public ViewSubjectHomeWorkBean() {
		...
		try {
			...
			if(checkRequest)
			{
				list = DBJ.viewSubjectAssignmentjson(selectedSection, newDate, endDate, schid, conn, selectedCLassSection, subjectid);
